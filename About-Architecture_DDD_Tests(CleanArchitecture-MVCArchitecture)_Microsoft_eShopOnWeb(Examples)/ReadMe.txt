请了解原理：https://zhuanlan.zhihu.com/p/2010854936175465801、https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/architectural-principles、https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures
...
请了解Microsoft_ORM_DataBase-Identity(Example)：内存形式的Nuget包的Microsoft.EntityFrameworkCore.InMemory免费内存数据库→.exe文件形式的SQL Server收费大型数据库（内置SQL Server LocalDB免费小型数据库）的下载安装使用【Microsoft公司】→.dll文件形式的SQLite免费小型数据库的VS的“SQLite/SQL Server Compact Toolbox”插件的下载安装使用【D.RichardHipp公司】。
